...
def test_create_user2(client):
    response = client.post(
        "/auth/signup/user",
        json={"username": "testdata2", "password": "test@123456789"},
    )
...
def test_get_user_by_id(client):
    signup_response = client.post(
        "/auth/signup/admin",
        json={"username": "test2", "email": "test2@gmail.com", "password": "test2"},
    )
    assert signup_response.status_code == 201
    signup_data = signup_response.json()
    ...
    response = client.post(
        "/auth/login", data={"username": "test2", "password": "test2"}
    )
...
def test_update_user_by_id(client):
    ...
    signup_response = client.post(
        "/auth/signup/user",
        json={"username": "test3", "email": "test3@gmail.com", "password": "test3"},
    )
    assert signup_response.status_code == 201
    signup_data = signup_response.json()
    user_id = signup_data["id"]
    ...
    signup_response2 = client.post(
        "/auth/signup/admin",
        json={"username": "test5", "email": "test5@gmail.com", "password": "test5"},
    )
    ...
    # login code
    response = client.post(
        "/auth/login", data={"username": "test5", "password": "test5"}
    )
    ...
    update_res = client.put(
        ...
        headers=headers,
        json={"username": "test4", "email": "test4@gmail.com", "password": "test1234"},
    )
...
def test_delete_user_by_id(client):
    ...
    signup_response = client.post(
        "/auth/signup/user",
        json={"username": "test12", "email": "test12@gmail.com", "password": "test6"},
    )
    assert signup_response.status_code == 201
    signup_data = signup_response.json()
    user_id = signup_data["id"]
    ...
    signup_response2 = client.post(
        "/auth/signup/admin",
        json={"username": "test7", "email": "test7@gmail.com", "password": "test7"},
    )
    assert signup_response2.status_code == 201
    signup_data = signup_response2.json()
    user_id_2 = signup_data["id"]
    ...
    response = client.post(
        "/auth/login", data={"username": "test7", "password": "test7"}
    )
...
def test_batch_delete(client):
    ...
    signup_response = client.post(
        "/auth/signup/user",
        json={"username": "test11", "email": "test11@gmail.com", "password": "test11"},
    )
    assert signup_response.status_code == 201
    signup_data = signup_response.json()
    user_id = signup_data["id"]
    ...
    signup_response3 = client.post(
        "/auth/signup/admin",
        json={"username": "test8", "email": "test8@gmail.com", "password": "test8"},
    )
    ...
    # login code
    response = client.post(
        "/auth/login", data={"username": "test8", "password": "test8"}
    )
...
def test_view_trash(client):
    signup_response = client.post(
        "/auth/signup/admin",
        json={"username": "demo", "email": "demo@gmail.com", "password": "demo"},
    )
    assert signup_response.status_code == 201
    signup_data = signup_response.json()
...
def test_restore_trash(client):
    ...
    signup_response2 = client.post(
        "/auth/signup/user",
        json={"username": "test14", "email": "test14@gmail.com", "password": "test14"},
    )
    assert signup_response2.status_code == 201
    signup_data2 = signup_response2.json()
    ...
    response = client.post(
        "/auth/login", data={"username": "admin12", "password": "admin12"}
    )
...
def test_permamently_delete(client):
    response = client.post(
        "/auth/signup/admin",
        json={"username": "test19", "email": "test122@gmail.com", "password": "test19"},
    )
    assert response.status_code == 201
    res = client.post(
        "/auth/signup/user",
        json={"username": "test13", "email": "test13@gmail.com", "password": "test6"},
    )
    ...
    permament_delete_res = client.delete(
        f"/auth/permamently-delete/{user_id}", headers=headers
    )
    assert permament_delete_res.status_code == 200
    assert (
        permament_delete_res.json()["message"]
        == "User Permamently Deleted Successfully"
    )
